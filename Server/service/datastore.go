...
type Store interface {
	...
	UpsertPushSubscription(ctx context.Context, userID int64, endpoint, p256dh, auth, deviceName, keyID string) (int64, error)
	...
	TrimPushSubscriptions(ctx context.Context, userID int64, keep int) error
