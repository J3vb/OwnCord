...
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `052_retention_revision`        | Removes retention revision tracking and its triggers. Existing retention settings and message history remain intact. Preview tokens must be obtained again after restarting or reapplying the migration.                                                                                                                                 |
