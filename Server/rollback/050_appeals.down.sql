-- Rollback of the B5-10 appeals migration (050).
--
-- Run this BEFORE 049's reversal: appeals.action_id references
-- moderation_actions(id), and dropping that table first would leave this
-- foreign key nothing to point at.
--
