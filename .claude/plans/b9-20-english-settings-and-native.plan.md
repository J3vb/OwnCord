...
For Rust-owned visible text use the Q7-approved shared catalog/interface or a documented native catalog with extraction tests; do not pull credentials, E2EE or media logic across the platform seam just to translate labels.
