...
audit history (`audit_log.subject_token`, migration 038).
...
`Server/internal/app/erasure.go`, `Server/service/erasure.go`, `Server/db/account.go`, `Server/db/attachment_queries.go`
