...
| 5   | Recovery secrets           | `recovery_kits` (argon2id verifier, created/used timestamps — B4-5; B4-6 adds issued credentials)                                          | `user_id`                                        | —                                                                                                                                                                                                                  | —                                 | Created by B4-5/B4-6 with erasure and rotation (O8) built in.                                                                                                            |
