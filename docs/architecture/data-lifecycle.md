...
| 5   | Recovery secrets           | `recovery_kits` (argon2id verifier, created/used timestamps — B4-5); `recovery_assists` (argon2id verifier of an owner-issued credential, issuer, verification wording, created/expires — B4-6; deleted on redemption, replaced on re-issue) | `user_id`                                        | —                                                                                                                                                                                                                  | —                                 | Created by B4-5/B4-6 with erasure and rotation (O8) built in.                                                                                                            |
