...
| `ws/serve_ready.go`               | `Channel×9` `ChannelOverride×6` `ChannelUnread×2` `DMChannelInfo×4` `MemberSummary×3` `Role×4` `User` `VoiceState×4`                                            | `StatusOffline×3`                                                                     | `MessageDeliveryFloorMS`                                                                                                                                                        | calls     | adapter     | —      | ready snapshot reads through ReadySnapshotReader; fresh-connect stale-voice cleanup through VoiceService                                                                                      |
