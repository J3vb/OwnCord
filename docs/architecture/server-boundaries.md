...
| `admin/handlers_users.go`         | `Role` `ServerStats` `User` `UserListFilter`                                                                                                                                                            | —                                                                                                                | —                                                                                                                                                                               | —                                                                                                                                                                   | type-only | adapter     | —      | UserWithRole/User/Role types in the panel response shapes; UserService owns the reads                                                                                                         |
