...
**Status:** COMPLETE — 2026-09-25. B9-0 through B9-26 are merged on `dev`; B9-27 records the exit, and the HP-9 exit was accepted by the owner the same day ([hp-9-scorecard-2026-09-25.md](hp-9-scorecard-2026-09-25.md)). The freeze on features, English strings, protocol and migrations is in effect; the pre-beta admin-panel overhaul (AO-1..AO-8) lands after it. Per-lane status below is updated from each merged lane's own plan record and its merged PR. **Every merged lane's native NVDA/Orca screen-reader recordings were declined by the owner on 2026-09-24**, so those recordings no longer gate any lane. **The manual OS 200 % zoom check was replaced by automated evidence on 2026-09-25**: `Client/tests/e2e/b9-zoom.spec.ts` (built on `Client/tests/e2e/support/b9-zoom.ts`) renders every lane's screen at the 200 % zoom viewport and runs the reflow audit, so no lane carries an owner OS-zoom item any more. Owner visual acceptance for B9-2 and B9-21..24 was given on 2026-09-25 ("b9 all ok").
**Entry gate:** the Q9 conditions were met 2026-09-23 (HP-7 signed, B5 consent follow-up accepted, B7-10/B7-11 merged), so B9-4 onward started in gate order; the per-row analysis further below is the historical record.
**Owner decisions:** Q1–Q13 decided 2026-09-23 ([Open questions](#open-questions)); Q13 (visual direction) is a dated amendment.
**B9-0 complete 2026-09-23** at `dev` `f32149c47756b06f2400d484b3347fd782586ff3`, merged [#1726](https://github.com/J3vb/OwnCord/pull/1726):
[b9-entry-baseline-2026-09-23.md](b9-entry-baseline-2026-09-23.md) records the drift, verdicts and baselines.
**B9-1 complete — merged [#1731](https://github.com/J3vb/OwnCord/pull/1731); NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-2 implemented — merged [#1736](https://github.com/J3vb/OwnCord/pull/1736); owner visual acceptance given 2026-09-25, NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-3 implemented — merged [#1739](https://github.com/J3vb/OwnCord/pull/1739); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-4 implemented — merged [#1750](https://github.com/J3vb/OwnCord/pull/1750); NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-5 implemented — merged [#1761](https://github.com/J3vb/OwnCord/pull/1761); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-6 implemented — merged [#1770](https://github.com/J3vb/OwnCord/pull/1770); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-7 implemented — merged [#1755](https://github.com/J3vb/OwnCord/pull/1755); NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-8 implemented — merged [#1771](https://github.com/J3vb/OwnCord/pull/1771); NVDA/Orca declined 2026-09-24 — 2026-09-23**:
[the plan's implementation record](../../.claude/plans/b9-8-external-content-consent.plan.md#implementation-record-2026-09-23) records Q3's
per-server choice, the admission check in front of every broker and GIF-proxy call, the Text & Images revocation and the zero pre-consent
broker traffic proof ([b9-content-consent.spec.ts](../../Client/tests/e2e/b9-content-consent.spec.ts), native
[b9-content-consent.spec.ts](../../Client/tests/e2e/native/b9-content-consent.spec.ts)) on base `838bab09`. Within the shared budgets:
startup closure 94,790 B, MainPage 63,508 B.
**B9-9 implemented — merged [#1775](https://github.com/J3vb/OwnCord/pull/1775); e2e follow-up [#1778](https://github.com/J3vb/OwnCord/pull/1778); NVDA/Orca declined 2026-09-24 — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-9-rich-content-states.plan.md#implementation-record-2026-09-24) records the typed
`OgLoad` view states, the bounded explicit retry with its policy-refusal rules, the keyboard-operable inline image and lightbox
(`role="button"`/`role="dialog"` with `aria-modal` and focus trap), the new `i18n/content.ts` and `i18n/mediaControls.ts` catalogs
and the reduced-motion/no-new-animation check.
**B9-10 implemented — merged [#1754](https://github.com/J3vb/OwnCord/pull/1754); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-11 implemented — merged [#1774](https://github.com/J3vb/OwnCord/pull/1774); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-23**:
[the plan's implementation record](../../.claude/plans/b9-11-moderation-queue-evidence.plan.md#implementation-record-2026-09-23) records the
permission-gated queue and per-report evidence behind the B5 consent contract (#1735), the real-server role, consent and role-loss journey
and the Q1 checks on base `64a41b3a`.
**B9-12 implemented — merged [#1777](https://github.com/J3vb/OwnCord/pull/1777); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-12-moderation-workflow.plan.md#implementation-record-2026-09-24) records the
take/note/close review controls with immutable history, one write at a time with server state replacing the view's guess on every
answer, and the confidentiality journey (no notes to a reporter, 404 to the subject).
**B9-13 implemented — merged [#1784](https://github.com/J3vb/OwnCord/pull/1784); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-13-warning-timeout-actions.plan.md#implementation-record-2026-09-24) records the
warn and timeout action forms (Q10's validated one-number-plus-unit duration, no presets), lift-timeout, the exact server contract
facts the client relies on, and the report-linked act route outcomes.
**B9-14 implemented — merged [#1787](https://github.com/J3vb/OwnCord/pull/1787); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-14-removal-kick-ban-controls.plan.md#implementation-record-2026-09-24) records
removal/kick/ban offered from a report and the per-channel voice-moderation authority from Q5's merged
[#1732](https://github.com/J3vb/OwnCord/pull/1732) (`can_moderate_voice` in `ready` and targeted `channel_create`).
**B9-15 implemented — merged [#1757](https://github.com/J3vb/OwnCord/pull/1757); NVDA/Orca declined 2026-09-24 — 2026-09-23**:
[the plan's implementation record](../../.claude/plans/b9-15-moderation-notices.plan.md#implementation-record-2026-09-23) records the
recipient-side notices banner (Q4), the timeout restriction states, the server-clock reconciliation and the Safety-tab history
behind Q6's merged [#1730](https://github.com/J3vb/OwnCord/pull/1730).
**B9-16 implemented — merged [#1763](https://github.com/J3vb/OwnCord/pull/1763); NVDA/Orca declined 2026-09-24 — 2026-09-23**:
[the plan's implementation record](../../.claude/plans/b9-16-personal-appeals.plan.md#implementation-record-2026-09-23) records the
Safety-tab appeal submission/withdrawal/status journeys, one appeal per action, the real action ids from Q6's read and the focus rules.
**B9-17 implemented — merged [#1786](https://github.com/J3vb/OwnCord/pull/1786); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-17-moderation-appeal-review.plan.md#implementation-record-2026-09-24) records the
Moderation Center Appeals tab and queue/detail with decide, the self-review and sole-moderator exceptions, and the DTOs that drop the
statement and decision note from the list.
**B9-18 implemented — merged [#1759](https://github.com/J3vb/OwnCord/pull/1759); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-19 implemented — merged [#1781](https://github.com/J3vb/OwnCord/pull/1781); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-19-english-messaging-content.plan.md#implementation-record-2026-09-24) records the
messaging/requests/messageStatus catalogs (408 literals across 21 files at base `782e010e`), the search-index data exclusion
(`emoji-keywords.ts`) and the side effect that took MainPage back under its 64,000 B budget.
**B9-20 implemented — merged [#1772](https://github.com/J3vb/OwnCord/pull/1772); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-21 implemented — merged [#1773](https://github.com/J3vb/OwnCord/pull/1773); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-23**:
[the plan's implementation record](../../.claude/plans/b9-21-shell-polish-and-performance.plan.md#implementation-record--2026-09-23)
...
**B9-22 implemented — merged [#1785](https://github.com/J3vb/OwnCord/pull/1785); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-22-messaging-interaction-polish.plan.md#implementation-record--2026-09-24) records
focus survival across a virtualized message-list rebuild, the named
scroll-to-bottom button, the removal of hover-only actions (`:focus-within`
reveal), the real search-overlay combobox, the Q1 contrast moves off
`--text-micro` and the 24 px target floors.
**B9-23 implemented — merged [#1779](https://github.com/J3vb/OwnCord/pull/1779); 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24 — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-23-account-settings-polish.plan.md#implementation-record--2026-09-24) records
feedback colour moved onto the qualified status tokens, announced-once form
messages with `aria-invalid`/`aria-describedby` field links, real labels on the
secret/password inputs and focus survival across a rebuilt account section.
**B9-24 implemented — merged [#1789](https://github.com/J3vb/OwnCord/pull/1789); NVDA/Orca declined 2026-09-24 — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-24-voice-media-polish.plan.md#implementation-record--2026-09-24) records the
keyboard-operable transport-stats button, the qualified status-text tokens, the
moderator mute/deafen announcement, no hover-only video-grid action, focus
survival across a tile rebuild and the keyboard-operable mic-sensitivity slider.
**B9-25 implemented — merged [#1795](https://github.com/J3vb/OwnCord/pull/1795); NVDA/Orca declined 2026-09-24 — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-25-honest-desktop-capabilities.plan.md#implementation-record--2026-09-24) records the
actionable connection notice (`serverUnreachable`/`deviceOffline` with a safe
Retry), the once-only live-region announcements, the honest notification
capability row and the manual-install update limitation.
**B9-26 implemented — merged [#1797](https://github.com/J3vb/OwnCord/pull/1797) at `dev` `a685929c`; native journey J passed in `client-native` — 2026-09-25**:
[b9-journey-evidence-2026-09-25.md](b9-journey-evidence-2026-09-25.md) is the
journey manifest. Nine real-server journeys
([fullstack/b9-journeys.spec.ts](../../Client/tests/e2e/fullstack/b9-journeys.spec.ts))
chain report→warn→notice→appeal→decision, retention→reported+appealed
self-erasure→observer cleanup, first-contact→text-only preview→accept→block→
composer gating, second-device session displacement→"Use here",
recovery-kit→logout→recovery, network cut→B9-25 notice→reconnect, refused-role
...
confinement in the real Windows app; it is CI-only on a non-Windows host and
**passed** in the `client-native` Windows job on CI run
[36127046517](https://github.com/J3vb/OwnCord/actions/runs/36127046517). No production fix was required; the shared
...
| B5 consent acceptance       | The public follow-up requires moderation-evidence consent verification before B9 interfaces ([B5 exit gate](b5-community-content-moderation-2026-09-04.md#exit-gate), "Conditions 3 and 4"). HP-5 accepted a design and narrowed server exits (`docs/plans/hp-5-scorecard-2026-09-05.md:18-28`, `:279-291`). The follow-up merged as [#1735](https://github.com/J3vb/OwnCord/pull/1735) and the owner accepted it 2026-09-23. | The consent prerequisite for B9 interfaces is accepted. **The B5 exit was accepted by the owner 2026-09-24 at `458301fd`** ([exit-SHA measurement](b5-community-content-moderation-2026-09-04.md#exit-sha-measurement-2026-09-24)); security-review details stay private. |
...
Scope is the eleven B9 workstreams in the roadmap's
[B9 section](repo-health-roadmap-2026-08-23.md#b9--complete-unified-feature-ux-accessibility-and-polish), read with all dated
...
| 2026-09-18 B8 deferral (roadmap [B8](repo-health-roadmap-2026-08-23.md#b8--deliver-browser-pwa-phone-and-tablet-support))                                                           | Beta is Windows x64/ARM64 and Linux x64/ARM64 desktop only. Browser/PWA/phone/tablet, touch-device, responsive-device and unsupported-browser-API evidence move with B8. Desktop keyboard, screen reader, focus, contrast, reduced motion, text scaling, zoom/reflow and visual regression remain blocking.                                                                                                            |
| 2026-09-18 B10 direction; Q12 confirmed at HP-9 2026-09-25 (roadmap [B10](repo-health-roadmap-2026-08-23.md#b10--qualify-and-publish-the-public-beta))                              | HP-9 confirms/revises the cut list. Do not make thirty-run/14-day-soak work a new B9 milestone, silently waive retained RC gates, or settle the comprehension-read method for the owner.                                                                                                                                                                                                                               |
| 2026-09-23 owner decisions Q1–Q12, including the Q9 amendment ([Open questions](#open-questions))                                                                                   | B9-0, B9-1, B9-2 and B9-3 start in that serialized order; B9-4 onward keeps the gate order below. Q5/Q6 upstream contract PRs were decided 2026-09-23 and **implemented**: Q5's `can_moderate_voice` merged ([#1732](https://github.com/J3vb/OwnCord/pull/1732)) and Q6's `GET /api/v1/users/me/moderation` merged ([#1730](https://github.com/J3vb/OwnCord/pull/1730)). Q11/Q12 were confirmed at HP-9 on 2026-09-25. |
...
Q5/Q6 required narrowly scoped upstream contract PRs. Their payloads were
decided by the owner on 2026-09-23 (see Q5 and Q6) and **both merged**: Q5's
`can_moderate_voice` as [#1732](https://github.com/J3vb/OwnCord/pull/1732) and
Q6's `GET /api/v1/users/me/moderation` as [#1730](https://github.com/J3vb/OwnCord/pull/1730),
linked from B9-14 and B9-15/16. These were explicit blocking handoffs, not
omitted work or implied authorization to widen those PRs.
...
| B5 contracts stable and security-reviewed                                       | **MET 2026-09-24**                       | Consent follow-up ([#1735](https://github.com/J3vb/OwnCord/pull/1735)) accepted by the owner 2026-09-23 ([evidence](b5-community-content-moderation-2026-09-04.md#exit-gate), "Conditions 3 and 4"). **The B5 exit was accepted by the owner 2026-09-24 at `458301fd`** ([exit-SHA measurement](b5-community-content-moderation-2026-09-04.md#exit-sha-measurement-2026-09-24)), recording all seven conditions met. Security-review status is private. |
| Agreed tokens, interaction patterns and accessibility test rules                | **MET 2026-09-25**                       | Q1/Q2/Q8 decided 2026-09-23; the named reviewer is the repository owner (Q1). B9-0 recorded the baseline and rule set; owner acceptance was given 2026-09-25 ("b9 all ok") for B9-2 and B9-21..24, and the manual OS 200 % zoom check was replaced by automated evidence the same day.                                                                                                                                                                  |
| Recipient discovery and effective voice UI contracts                            | **Implemented**                          | Q5 (`can_moderate_voice`) merged ([#1732](https://github.com/J3vb/OwnCord/pull/1732)) and consumed by B9-14; Q6 (`GET /api/v1/users/me/moderation`) merged ([#1730](https://github.com/J3vb/OwnCord/pull/1730)) and consumed by B9-15/16.                                                                                                                                                                                                               |
...
| ------------------------------------------------------------------------ | ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [B9-0](../../.claude/plans/b9-0-entry-evidence-and-decisions.plan.md)    | Verify entry evidence and settle the execution contract                 | Entry evidence preparation only                                                                                                  | entry; 8, 10        | **Merged [#1726](https://github.com/J3vb/OwnCord/pull/1726)** — Done                                                                                                                                                                                                                                                                                                                           |
| [B9-1](../../.claude/plans/b9-1-css-source-split.plan.md)                | Split app.css without changing its output                               | B9-0                                                                                                                             | 11                  | **Merged [#1731](https://github.com/J3vb/OwnCord/pull/1731)** — Complete; NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                                                                        |
| [B9-2](../../.claude/plans/b9-2-shared-accessibility-and-tokens.plan.md) | Apply the agreed shared accessibility and token rules                   | B9-1                                                                                                                             | 7, 8                | **Merged [#1736](https://github.com/J3vb/OwnCord/pull/1736)** — Implemented; owner visual acceptance given 2026-09-25, NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                           |
| [B9-3](../../.claude/plans/b9-3-english-text-boundary.plan.md)           | Introduce the English text and formatting boundary                      | B9-2                                                                                                                             | 6                   | **Merged [#1739](https://github.com/J3vb/OwnCord/pull/1739)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-4](../../.claude/plans/b9-4-shared-navigation.plan.md)               | Add the agreed shared navigation integration points                     | B9-3                                                                                                                             | 7, 8                | **Merged [#1750](https://github.com/J3vb/OwnCord/pull/1750)** — Implemented; NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                                                                     |
| [B9-5](../../.claude/plans/b9-5-message-requests-inbox.plan.md)          | Show the Message Requests inbox and safe text preview                   | B9-4                                                                                                                             | 1, 8                | **Merged [#1761](https://github.com/J3vb/OwnCord/pull/1761)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-6](../../.claude/plans/b9-6-message-request-decisions.plan.md)       | Accept, ignore, delete or block a Message Request                       | B9-5                                                                                                                             | 1, 8                | **Merged [#1770](https://github.com/J3vb/OwnCord/pull/1770)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-7](../../.claude/plans/b9-7-nsfw-consent-gate.plan.md)               | Make NSFW consent an authoritative pre-load gate                        | B9-4                                                                                                                             | 3, 8                | **Merged [#1755](https://github.com/J3vb/OwnCord/pull/1755)** at `bca39fe4` on `166d71e4`; NVDA/Orca declined 2026-09-24; [evidence](../../.claude/plans/b9-7-nsfw-consent-gate.plan.md#evidence), [spec](../../Client/tests/e2e/b9-nsfw-consent.spec.ts)                                                                                                                                      |
| [B9-8](../../.claude/plans/b9-8-external-content-consent.plan.md)        | Apply external-content consent before broker or provider work           | B9-7, B9-3                                                                                                                       | 2, 8                | **Merged [#1771](https://github.com/J3vb/OwnCord/pull/1771)** on `838bab09`; NVDA/Orca declined 2026-09-24; [evidence](../../.claude/plans/b9-8-external-content-consent.plan.md#evidence), [spec](../../Client/tests/e2e/b9-content-consent.spec.ts)                                                                                                                                          |
| [B9-9](../../.claude/plans/b9-9-rich-content-states.plan.md)             | Polish approved rich-content loading, failure and media controls        | B9-8                                                                                                                             | 2, 8                | **Merged [#1775](https://github.com/J3vb/OwnCord/pull/1775)** (e2e follow-up [#1778](https://github.com/J3vb/OwnCord/pull/1778)) — Implemented; NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                  |
| [B9-10](../../.claude/plans/b9-10-local-report-intake.plan.md)           | Report local messages, users and attachments and show own report status | B9-4, B9-3                                                                                                                       | 4, 8                | **Merged [#1754](https://github.com/J3vb/OwnCord/pull/1754)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-11](../../.claude/plans/b9-11-moderation-queue-evidence.plan.md)     | Show the permission-gated moderation queue and authorized evidence      | B9-4, B9-7, B9-10                                                                                                                | 4, 8                | **Merged [#1774](https://github.com/J3vb/OwnCord/pull/1774)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-12](../../.claude/plans/b9-12-moderation-workflow.plan.md)           | Assign, annotate and close reports with immutable history               | B9-11                                                                                                                            | 4, 8                | **Merged [#1777](https://github.com/J3vb/OwnCord/pull/1777)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-13](../../.claude/plans/b9-13-warning-timeout-actions.plan.md)       | Issue warnings and timeouts with accurate outcomes                      | B9-12                                                                                                                            | 4, 5, 8             | **Merged [#1784](https://github.com/J3vb/OwnCord/pull/1784)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-14](../../.claude/plans/b9-14-removal-kick-ban-controls.plan.md)     | Finish narrow removal, kick, ban and effective voice controls           | B9-13                                                                                                                            | 4, 5, 8             | **Merged [#1787](https://github.com/J3vb/OwnCord/pull/1787)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-15](../../.claude/plans/b9-15-moderation-notices.plan.md)            | Show authorized warnings, restrictions and action status to recipients  | B9-4, B9-3                                                                                                                       | 5, 8                | **Merged [#1757](https://github.com/J3vb/OwnCord/pull/1757)** — Implemented; NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                                                                     |
| [B9-16](../../.claude/plans/b9-16-personal-appeals.plan.md)              | Submit and track a local appeal                                         | B9-15                                                                                                                            | 5, 8                | **Merged [#1763](https://github.com/J3vb/OwnCord/pull/1763)** — Implemented; NVDA/Orca declined 2026-09-24 ([evidence](../../.claude/plans/b9-16-personal-appeals.plan.md#evidence))                                                                                                                                                                                                           |
| [B9-17](../../.claude/plans/b9-17-moderation-appeal-review.plan.md)      | Review and decide appeals without overexposing information              | B9-12, B9-13, B9-16                                                                                                              | 4, 5, 8             | **Merged [#1786](https://github.com/J3vb/OwnCord/pull/1786)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-18](../../.claude/plans/b9-18-english-shell-connect.plan.md)         | Extract connect, shell and navigation text                              | B9-4                                                                                                                             | 6                   | **Merged [#1759](https://github.com/J3vb/OwnCord/pull/1759)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-19](../../.claude/plans/b9-19-english-messaging-content.plan.md)     | Extract messaging, rich-content and media text                          | B9-9, B9-6, B9-18                                                                                                                | 6                   | **Merged [#1781](https://github.com/J3vb/OwnCord/pull/1781)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-20](../../.claude/plans/b9-20-english-settings-and-native.plan.md)   | Extract settings, account and desktop-owned text                        | B9-3, B9-18                                                                                                                      | 6                   | **Merged [#1772](https://github.com/J3vb/OwnCord/pull/1772)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-21](../../.claude/plans/b9-21-shell-polish-and-performance.plan.md)  | Polish desktop shell navigation without rebuilding it on every update   | B9-4, B9-18                                                                                                                      | 7, 8                | **Merged [#1773](https://github.com/J3vb/OwnCord/pull/1773)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-22](../../.claude/plans/b9-22-messaging-interaction-polish.plan.md)  | Polish desktop message reading, composing and related overlays          | B9-19, B9-7                                                                                                                      | 7, 8                | **Merged [#1785](https://github.com/J3vb/OwnCord/pull/1785)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-23](../../.claude/plans/b9-23-account-settings-polish.plan.md)       | Polish account, privacy, recovery and settings journeys                 | B9-20                                                                                                                            | 7, 8, 10            | **Merged [#1779](https://github.com/J3vb/OwnCord/pull/1779)** — Implemented; 200 % zoom automated (b9-zoom.spec.ts), NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                             |
| [B9-24](../../.claude/plans/b9-24-voice-media-polish.plan.md)            | Polish voice and video controls and their accessibility                 | B9-20, B9-14                                                                                                                     | 7, 8                | **Merged [#1789](https://github.com/J3vb/OwnCord/pull/1789)** — Implemented; NVDA/Orca declined 2026-09-24                                                                                                                                                                                                                                                                                     |
| [B9-25](../../.claude/plans/b9-25-honest-desktop-capabilities.plan.md)   | Make desktop network, notification and update limitations actionable    | B9-9, B9-15, B9-23, B9-24                                                                                                        | 9, 8                | **Merged [#1795](https://github.com/J3vb/OwnCord/pull/1795)** — Implemented; NVDA/Orca declined 2026-09-24; [evidence](../../.claude/plans/b9-25-honest-desktop-capabilities.plan.md#implementation-record--2026-09-24), [spec](../../Client/tests/e2e/b9-desktop-capabilities.spec.ts)                                                                                                        |
| [B9-26](../../.claude/plans/b9-26-cross-feature-journeys.plan.md)        | Qualify complete desktop privacy, moderation and lifecycle journeys     | B9-6, B9-7, B9-9, B9-10, B9-11, B9-12, B9-13, B9-14, B9-15, B9-16, B9-17, B9-18, B9-19, B9-20, B9-21, B9-22, B9-23, B9-24, B9-25 | 10, 8               | **Merged [#1797](https://github.com/J3vb/OwnCord/pull/1797)** — Implemented; NVDA/Orca declined 2026-09-24; native journey J passed in the `client-native` Windows job on CI run 36127046517; [evidence manifest](b9-journey-evidence-2026-09-25.md), [fullstack spec](../../Client/tests/e2e/fullstack/b9-journeys.spec.ts), [native spec](../../Client/tests/e2e/native/b9-journeys.spec.ts) |
| [B9-27](../../.claude/plans/b9-27-hp9-freeze-and-exit.plan.md)           | Record HP-9 feature freeze and the B9 exit decision                     | B9-26                                                                                                                            | HP-9; exit          | **Complete — 2026-09-25**; [HP-9 scorecard](hp-9-scorecard-2026-09-25.md); freeze and admin-panel freeze-impact note recorded                                                                                                                                                                                                                                                                  |
...
| BPR-091     | Every milestone        | Keyboard, pointer, screen reader, focus, contrast, reduced motion, text scale/zoom/reflow, announcements/errors/media controls; no release blocker. B8 device clauses remain deferred. _Amended 2026-09-24 (owner decision): the manual screen-reader check is dropped; the automated accessibility evidence every B9 lane carries (ARIA name/role and keyboard/focus tests) satisfies the screen-reader clause._ _Amended 2026-09-25 (owner decision): the manual OS 200 % zoom owner check is replaced by the automated reflow evidence in `Client/tests/e2e/b9-zoom.spec.ts`; the 200 % zoom fixes land before beta (drawer [#1808](https://github.com/J3vb/OwnCord/pull/1808), Logs reflow [#1806](https://github.com/J3vb/OwnCord/pull/1806))._ |
...
The ledger's open entries at HP-9 (2026-09-25) are **six**, all low and none a
B9-tagged finding: OC-0454, OC-0473, OC-0474, OC-0476, OC-0478 and OC-0479. The
B9-tagged B9-0 reconciliation found **24 fixed, zero open** (OC-0314..OC-0375,
above), and the B9 exit audit (`OC-0460`–`OC-0479`) fixed thirteen, declined two
as screen-reader-only work (owner 2026-09-25) and left those five open for after
the beta. **No B9 workstream closes one of the remaining open findings.** They
remain with their existing owners and release gates. Newly verified B9 defects
must enter the canonical ledger or a private advisory before remediation. Phase
exit requires no open B9-tagged finding unless the owner explicitly retags it
with a written reason in the scorecard; a known exploitable beta blocker is not
accepted risk. The register's live summary is the authority for current counts.

_Drift at `f32149c4` (B9-0):_ OC-0446, OC-0447 and OC-0448 have since been
fixed and OC-0449..OC-0451 recorded and fixed; OC-0445 was then the ledger's only
open entry. None is a B9 finding. The 2026-09-25 B9 exit audit added the six
open lows above.

## HP-9 — Feature freeze and accessibility acceptance

B9-27 prepares [hp-9-scorecard-2026-09-25.md](hp-9-scorecard-2026-09-25.md)
with the exact candidate commit, B9-26 evidence manifest, every requirement
journey, accessibility defect disposition and gate verdict. **The scorecard is
written 2026-09-25 and the B9 exit was accepted by the owner the same day.** The
scorecard supplies the owner's signature record; this plan does not. Freeze
features, English strings, protocol, migrations and user-visible behavior from
2026-09-25. Blocker fixes require focused PRs, explicit freeze-impact review and
new candidate evidence. The owner-approved pre-beta admin-panel overhaul
(AO-1..AO-8, "Refined Neon", `Server/admin/static` and admin UI strings/styles
only) lands after the freeze; its freeze-impact note is in the scorecard.
...
| No accessibility release blocker                                                                          | Per-milestone keyboard/pointer scripts; focus order/restore proof; measured contrast; OS/app reduced motion; approved text scaling and desktop zoom/reflow; accessible names/errors/status/media controls. Automated reports supplement the remaining manual checks. Native screen-reader recordings with OS/AT versions were **declined by the owner 2026-09-24** (Q1 amendment) and are not required for B9 closure; the manual screen-reader check is **dropped** (owner decision 2026-09-24), since the automated accessibility evidence (ARIA name/role and keyboard/focus tests) satisfies the screen-reader clause. The manual OS 200 % zoom check is **replaced by the automated reflow evidence** in `Client/tests/e2e/b9-zoom.spec.ts` (owner decision 2026-09-25, "automate the zoom"), with the per-lane mapping recorded in the Q1 amendment below; the 200 % zoom fixes (drawer [#1808](https://github.com/J3vb/OwnCord/pull/1808), Logs reflow [#1806](https://github.com/J3vb/OwnCord/pull/1806)) land before beta. |
...
native traffic, Windows/Linux media or OS assistive technology; the owner's
2026-09-24 decline of the native NVDA/Orca recordings is recorded in each lane,
so the automated accessibility evidence, including the automated 200 % zoom
reflow evidence, is the acceptance evidence here. Test names and
...
**Amended 2026-09-24 by the owner:** the native NVDA/Orca screen-reader recordings are **declined**; the owner will not record them. The remaining Q1 acceptance bar (thresholds, visible focus, target size, text spacing, text scale, OS zoom 200 %, reflow, reduced motion) and the automated evidence still apply. The per-milestone automated accessibility evidence remains the structural proxy; no lane is blocked by the absent recordings. Asked whether this also waives BPR-091's manual screen-reader check, the owner answered "drop manual check" (2026-09-24): the automated accessibility evidence (ARIA name/role and keyboard/focus tests) now replaces, rather than supplements, the manual screen-reader check, and no manual screen-reader pass is required before beta exit.

**Amended 2026-09-25 by the owner:** the manual OS 200 % zoom owner check is **replaced by the automated evidence** in `Client/tests/e2e/b9-zoom.spec.ts` ("automate the zoom"). Every lane that carried an owner OS-zoom item (B9-3, 5, 6, 10, 11, 12, 13, 14, 17, 18, 19, 20, 21, 22, 23) is covered by a reflow audit at the effective 200 % zoom viewport (640×400 CSS px, the layout a 1280×800 window shows at 200 % page zoom), so no lane keeps an owner OS-zoom item. The two 200 % zoom fixes landed before beta: the collapsed sidebar opened as a drawer ([#1808](https://github.com/J3vb/OwnCord/pull/1808)) and the Logs-tab reflow ([#1806](https://github.com/J3vb/OwnCord/pull/1806)). The per-lane test mapping is the table below.

| Lane  | Covering test in `Client/tests/e2e/b9-zoom.spec.ts`                                                                                                                       |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| B9-3  | "the message surface, its history and composer fit at 200 % zoom"                                                                                                         |
| B9-5  | "the requests inbox fits and its decisions stay reachable at 200 % zoom"                                                                                                  |
| B9-6  | "the request Block confirm fits at 200 % zoom"                                                                                                                            |
| B9-10 | "the report dialog fits at 200 % zoom"; "My reports in the Safety tab fits at 200 % zoom"                                                                                 |
| B9-11 | "the moderation queue fits at 200 % zoom"                                                                                                                                 |
| B9-12 | "the moderation review and its actions fit at 200 % zoom"                                                                                                                 |
| B9-13 | "the moderation review and its actions fit at 200 % zoom"                                                                                                                 |
| B9-14 | "the moderation review and its actions fit at 200 % zoom"; "the ban confirm fits at 200 % zoom"                                                                           |
| B9-17 | "the appeal decision form fits at 200 % zoom"                                                                                                                             |
| B9-18 | "the connect form fits and stays usable at 200 % zoom"; "the sidebar navigation stays reachable at 200 % zoom"                                                            |
| B9-19 | "the message surface, its history and composer fit at 200 % zoom"                                                                                                         |
| B9-20 | "the account pane fits at 200 % zoom"; "every settings tab opened from the connect page gear fits at 200 % zoom"                                                          |
| B9-21 | "the sidebar navigation stays reachable at 200 % zoom"; "the message surface, its history and composer fit at 200 % zoom"                                                 |
| B9-22 | "the message surface, its history and composer fit at 200 % zoom"; "the search overlay fits at 200 % zoom"                                                                |
| B9-23 | "the account pane fits at 200 % zoom"; "the Logs tab opened from the connect page gear fits at 200 % zoom"; "an unbroken log message in the Logs tab wraps at 200 % zoom" |

Every lane the JSON coverage note names has a covering test, so no lane stays pending.
...
**Sequencing confirmed at HP-9, 2026-09-25 (D-10):** the comprehension read runs against the release PR's CI artifacts before the tag, not against the published `beta.1`. The two readers are recruited by the owner; a miss is a documentation fix before the tag. The HP-9 scorecard opens the row as NOT RUN with the method fixed, and B10 closes it.
...
**Decided 2026-09-23 by the owner, confirmed at HP-9 on 2026-09-25:** confirm the 2026-09-18 table row by row, with two additions that do not change any verdict. First, give the "later beta-to-stable gate" a phase id now, **B11** (now recorded in the roadmap), so items 2, 3, 13, 14 and the moved half of item 11 have an owner row in the roadmap instead of "no phase id assigned yet". Second, at HP-9 re-examine only item 11's moderation half with the shipped B9 features in hand: if the Moderation Center, appeals and the out-of-band ban-appeal route ship in the beta, a one-page user guide for them stays in beta; accessibility, support, feedback and contribution documentation move as decided. **At HP-9 (2026-09-25) the owner confirmed the table and kept the one-page moderation/Moderation-Center guide in beta** (the Moderation Center, appeals and the ban-appeal route shipped with B9, so the guide is B10's DOC-09). Retained and unchanged: the RC matrix (1), alpha upgrade/rollback (4), protocol re-run (5), desktop/server/Docker matrix (6, 7), one capacity comparison (8), zero open P0/P1 and advisories (9), packaging/provenance/signing/update checks (10), safe release notes (12), item 15 per Q11, and HP-10.
