...
**B9-18 implemented — MainPage bundle-budget decision and native AT recordings pending owner — 2026-09-23**:
...
| [B9-18](../../.claude/plans/b9-18-english-shell-connect.plan.md)         | Extract connect, shell and navigation text                              | B9-4                                                                                                                             | 6                   | Implemented — budget decision and native AT pending owner   |
