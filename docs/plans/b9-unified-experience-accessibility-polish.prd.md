...
| [B9-14](../../.claude/plans/b9-14-removal-kick-ban-controls.plan.md)     | Finish narrow removal, kick, ban and effective voice controls           | B9-13                                                                                                                            | 4, 5, 8             | Implemented — native AT recordings and OS zoom pending owner                                                                                                                                       |
