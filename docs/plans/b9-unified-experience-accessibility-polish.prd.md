...
**B9-21 implemented — native AT recordings pending owner — 2026-09-23**:
...
**B9-8 implemented — native AT recordings pending owner — 2026-09-23**:
...
**B9-11 implemented — native AT recordings and OS-zoom check pending owner — 2026-09-23**:
...
**B9-12 implemented — native AT recordings and OS-zoom check pending owner — 2026-09-24**:
[the plan's implementation record](../../.claude/plans/b9-12-moderation-workflow.plan.md#implementation-record-2026-09-24) records
take, internal note and close on the existing queue endpoints, the one-write guard and 409 reconciliation, the separate notes and
read-only history, the real-server role matrix and race walkthrough and the Q1 checks on base `9c5f5d67`.
...
| [B9-8](../../.claude/plans/b9-8-external-content-consent.plan.md)        | Apply external-content consent before broker or provider work           | B9-7, B9-3                                                                                                                       | 2, 8                | Implemented on `838bab09` — native AT pending owner; [evidence](../../.claude/plans/b9-8-external-content-consent.plan.md#evidence), [spec](../../Client/tests/e2e/b9-content-consent.spec.ts)     |
...
| [B9-11](../../.claude/plans/b9-11-moderation-queue-evidence.plan.md)     | Show the permission-gated moderation queue and authorized evidence      | B9-4, B9-7, B9-10                                                                                                                | 4, 8                | Implemented — native AT pending owner                                                                                                                                                              |
| [B9-12](../../.claude/plans/b9-12-moderation-workflow.plan.md)           | Assign, annotate and close reports with immutable history               | B9-11                                                                                                                            | 4, 8                | Implemented — native AT pending owner                                                                                                                                                              |
...
| [B9-20](../../.claude/plans/b9-20-english-settings-and-native.plan.md)   | Extract settings, account and desktop-owned text                        | B9-3, B9-18                                                                                                                      | 6                   | Implemented — native AT pending owner                                                                                                                                                              |
| [B9-21](../../.claude/plans/b9-21-shell-polish-and-performance.plan.md)  | Polish desktop shell navigation without rebuilding it on every update   | B9-4, B9-18                                                                                                                      | 7, 8                | Implemented — native AT recordings pending owner                                                                                                                                                   |
