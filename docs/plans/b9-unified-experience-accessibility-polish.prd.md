...
**Merged lanes and remaining owner items (2026-09-24).** B9-0 through B9-24 are merged on `dev`; each lane's own plan record (`#implementation-record`) names its exact head and its merged PR. **The owner declined the native NVDA/Orca screen-reader recordings on 2026-09-24**, so they no longer gate any lane; where a lane below still lists an item as owner-run, only its owner visual acceptance and/or its OS 200 % zoom check remains open.
...
**B9-10 implemented — merged [#1754](https://github.com/J3vb/OwnCord/pull/1754); NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
**B9-17 implemented — merged [#1786](https://github.com/J3vb/OwnCord/pull/1786); NVDA/Orca declined 2026-09-24 — 2026-09-24**:
...
**B9-18 implemented — merged [#1759](https://github.com/J3vb/OwnCord/pull/1759); NVDA/Orca declined 2026-09-24 — 2026-09-23**:
...
| [B9-10](../../.claude/plans/b9-10-local-report-intake.plan.md)           | Report local messages, users and attachments and show own report status | B9-4, B9-3                                                                                                                       | 4, 8                | **Merged [#1754](https://github.com/J3vb/OwnCord/pull/1754)** — Implemented; NVDA/Orca declined 2026-09-24                                                                                                                                                |
