...
- Step 8: individual adjudication of the 38 open `OC-*` records. The count was
  verified as **332 fixed / 47 open / 3 declined / 1 duplicate = 383** (counts
  ...
  OC-0321, and B4-12(d) closed OC-0340 and OC-0341), matching the register, and a staleness pass confirmed **all 38 still resolve to a live
