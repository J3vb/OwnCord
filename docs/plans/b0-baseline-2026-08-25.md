...
- Step 8: individual adjudication of the 38 open `OC-*` records. The count was
  verified as **336 fixed / 43 open / 3 declined / 1 duplicate = 383** (counts
  ...
  OC-0321, B4-12(a) closed OC-0313 and OC-0329, B4-12(b) closed OC-0314, B4-12(d) closed OC-0340 and OC-0341, and B4-7's second half closed OC-0354), matching the register, and a staleness pass confirmed **all 38 still resolve to a live
