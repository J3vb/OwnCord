...
- Step 8: individual adjudication of the 38 open `OC-*` records. The count was
  verified as **330 fixed / 49 open / 3 declined / 1 duplicate = 383** (counts
  ...
  2026-09-01 post-merge review added OC-0380–0383 as fixed, and B4-12(b)'s
  client half closed OC-0314), matching the register, and a staleness pass confirmed **all 38 still resolve to a live
