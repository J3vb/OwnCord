...
- Step 8: individual adjudication of the 38 open `OC-*` records. The count was
  verified as **325 fixed / 50 open / 3 declined / 1 duplicate = 379** (counts
  re-derived 2026-08-31 after the B3-8 role family closed OC-0374 and its
  message/read-state family closed OC-0323, OC-0357 and OC-0358), matching the register, and a staleness pass confirmed **all 38 still resolve to a live
