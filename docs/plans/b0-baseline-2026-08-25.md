...
- Step 8: individual adjudication of the 38 open `OC-*` records. The count was
  verified as **331 fixed / 48 open / 3 declined / 1 duplicate = 383** (counts
  ...
  OC-0321, and B4-12(b) closed OC-0314), matching the register, and a staleness pass confirmed **all 38 still resolve to a live
