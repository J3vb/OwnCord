...
- Step 8: individual adjudication of the 38 open `OC-*` records. The count was
  verified as **445 fixed / 2 open / 4 declined / 1 duplicate = 452** (counts
  current as of the 2026-09-23 merges of the OC-0446/OC-0447 harness fixes and
  the OC-0448 release-digest fix; previously
  re-derived 2026-09-01 after the B3-8 role family closed OC-0374, and again
  2026-09-20 when the 2026-09-20 review added OC-0448-OC-0450, 2026-09-22 when N14 added OC-0451, and 2026-09-23 when PR #1707's presence retry fix closed it and OC-0448 was fixed; its
  message/read-state family closed OC-0323, OC-0357 and OC-0358, the
  2026-09-01 post-merge review added OC-0380–0383 as fixed, B4-3 closed
  OC-0321, B4-12(a) closed OC-0313 and OC-0329, B4-12(b) closed OC-0314, B4-12(d) closed OC-0340 and OC-0341, B4-7's second half closed OC-0354, and B4-12(c) closed OC-0324), matching the register, and a staleness pass confirmed **all 38 still resolve to a live
