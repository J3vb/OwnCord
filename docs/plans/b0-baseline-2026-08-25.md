...
> overwrote Step 8's measured counts. Restored the original observation from
> `6a1561fa` (the B0 record), checked against the ledger at the cited audit
> base `5cc0888964e26276d1aca145e83270a2c1b9febd`: 306 fixed / 38 open /
> 3 declined / 1 duplicate = 348. These are 2026-08-25 measurements, not
> current totals; later fixes do not change this baseline.
