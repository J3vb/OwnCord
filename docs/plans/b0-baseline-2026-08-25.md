...
- Step 8: individual adjudication of the 38 open `OC-*` records. The count was
  verified as **322 fixed / 53 open / 3 declined / 1 duplicate = 379** (counts
  re-derived 2026-08-31 after OC-0374 closed with the B3-8 role family), matching the register, and a staleness pass confirmed **all 38 still resolve to a live
