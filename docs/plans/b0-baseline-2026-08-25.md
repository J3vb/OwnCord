...
- Step 8: individual adjudication of the 38 open `OC-*` records. The count was
  verified as **321 fixed / 54 open / 3 declined / 1 duplicate = 379** (counts
  re-derived 2026-08-31 after OC-0379, the post-merge audit's fixed-on-arrival record), matching the register, and a staleness pass confirmed **all 38 still resolve to a live
