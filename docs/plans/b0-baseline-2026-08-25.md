...
- Step 8: individual adjudication of the 38 open `OC-*` records. The count was
  verified as **329 fixed / 50 open / 3 declined / 1 duplicate = 383** (counts
  re-derived 2026-09-01 after the B3-8 role family closed OC-0374, its
  message/read-state family closed OC-0323, OC-0357 and OC-0358, and the
  2026-09-01 post-merge review added OC-0380–0383 as fixed), matching the register, and a staleness pass confirmed **all 38 still resolve to a live
