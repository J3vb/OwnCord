...
- Step 8: individual adjudication of the 38 open `OC-*` records. The count was
  ...
  2026-09-01 post-merge review added OC-0380–0383 as fixed, and B4-3 closed
  OC-0321), matching the register, and a staleness pass confirmed **all 38 still resolve to a live
