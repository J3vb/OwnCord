...
| [hp-1-scorecard-2026-08-27](hp-1-scorecard-2026-08-27.md)                                 | **HP-1 review done; acceptance pending B1-7.** Structural-diff proofs for the flatten and module rename, plus the B1 exit gate.       |
