...
| [b2-protocol-trust-compat-2026-08-28](b2-protocol-trust-compat-2026-08-28.md)             | **B2 in progress from 2026-08-28.** Entry gate 1 of 3 met at draft; B2-1 and B2-9 close the other two. Step order: B2-0, B2-1, B2-8, then B2-2 → B2-3 → B2-4, with B2-5/6/7/9 in parallel. Ends at HP-2.                                                    |
