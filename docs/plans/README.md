...
| [b1-repository-foundation-2026-08-25](b1-repository-foundation-2026-08-25.md) | **Not started.** B1 execution plan. Blocked: HP-0 is not accepted. Re-verifies every RL-* claim against HEAD; several are refuted. |
