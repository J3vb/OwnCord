...
| [repo-health-roadmap-2026-08-23](repo-health-roadmap-2026-08-23.md)                       | Phase order and gates, B0–B10. **B0 and B1 complete** (HP-0 and HP-1 both accepted); **B2 in progress** — plan below. B3–B10 not started. **Amended 2026-08-28:** dated lines in B3–B10, a "Phase execution pattern" section, and a truthful status header. |
...
| [b2-protocol-trust-compat-2026-08-28](b2-protocol-trust-compat-2026-08-28.md)             | **B2 in progress from 2026-08-28.** Entry gate 1 of 3 met at draft; B2-1 and B2-9 close the other two. Step order: B2-0, B2-1, B2-8, then B2-2 → B2-3 → B2-4, with B2-6/7/9 in parallel and B2-5 serialized. Ends at HP-2.                                  |
