...
| #1520 | B4-10 — deletion markers and unlinkable audit history (stacked on #1517)                                          | open — draft                         |
| —     | B4-11 — retention (`feat/b4-11-retention`, stacked on #1520)                                                      | open — draft                         |
...
| B4-10 | `feat/b4-10-deletion-markers` | `6634863` (later fixes on `refs/pull/1520/head`)                                                                         | #1520  |
| B4-11 | `feat/b4-11-retention`        | _recorded when the PR is opened_                                                                                         | _open_ |
