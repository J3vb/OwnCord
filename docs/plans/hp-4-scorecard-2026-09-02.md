...
| #1521 | B4-11 — retention (carries #1522's fixes until they merge)                                                                                    | open — draft                         |
| #1522 | B4-10 review fixes — the audit-writer barrier, replay past the last-admin guard, pending markers applied, id floors, the actor's token column | open — draft                         |
...
| B4-11 | `feat/b4-11-retention`        | `972f82f` (later fixes on `refs/pull/1521/head`)                                                                                                                                                                       | #1521        |
