...
| —     | B4-9 review fix — the replay-pipeline purge and the persisted-envelope predicate (`fix/b4-9-replay-purge`) | open — draft                         |
...
| ----- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ----- |
| B4-9  | `feat/b4-9-account-erasure` | `8032d70` → squash `c9f06da`; Codex's two findings fixed in `9880604`, which landed after the merge and follows in `fix/b4-9-replay-purge` | #1516 |
| B4-10 | —                           | —                                                                                                                                          | —     |
| B4-11 | —                           | —                                                                                                                                          | —     |
