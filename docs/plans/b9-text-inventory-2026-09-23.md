...
| Scan and ratchet                                                                                     | `npx vitest run tests/unit/ui-strings.test.ts`                                            | 11 passed                                                                                                                                                                                                        |
| Failing control: the pilot reverted to its base file                                                 | same, with `AccessibilityTab.ts` from `4830b23c`                                          | **Fail**, 2 tests: ten "new UI text" entries (`Reduce Motion` …) and "holds nothing for the extracted pilot"                                                                                                     |
