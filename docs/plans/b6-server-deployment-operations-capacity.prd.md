...
| B6-13    | Operator documentation                                   | Local logs, support-bundle generation, capacity limits, ports, storage growth, certificate trust, recovery, updates and safe failure are all documented for a stranger. **Written 2026-09-18**; still owed: the Task 1 platform runs — verify where logs land on real systemd, NSSM, Docker and Task Scheduler hosts (no such host available in this session)                                                                                                                                                                                                                                                                        | in-progress | [b6-13-operator-documentation.plan.md](../../.claude/plans/b6-13-operator-documentation.plan.md)                             | 12         |
...
| **HP-6** | **Operator and capacity acceptance — the owner signs**   | An owner unfamiliar with the code deploys each mode from current documentation, understands the network and trust limits, recovers a backup, rotates trust and interprets failure. **2026-09-18:** the operator-usability record can now be attempted against deployment.md's headings; two facts were written from measurement rather than source — the live support-bundle download and the certificate-expiry behaviour (Go test `Server/auth/tls_expiry_test.go` + `Client/src-tauri/src/tofu.rs`)                                                                                                                               | pending     | —                                                                                                                            | HP-6       |
