...
| B6-2     | Docker images                                            | An owner runs the `linux/amd64` or `linux/arm64` image with persistent data, health, migration, graceful drain and minimal privilege                                                                             | in-progress | [b6-2-docker-images.plan.md](../../.claude/plans/b6-2-docker-images.plan.md)                         | 2          |
