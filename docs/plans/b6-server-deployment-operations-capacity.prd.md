...
| Workstream 3 (HTTPS/WSS modes)                                 | deferred            | B6-3/4 (open)                                                 | no           | dated deferred sentence, HP-6 decision 1                                       | no — final pass                     |
| Workstream 4 (port-forward honesty)                            | shipped             | B6-6 #1588                                                    | no           | —                                                                              | no                                  |
| Workstream 5 (cert lifecycle)                                  | deferred            | B6-5 (open)                                                   | no           | dated deferred sentence, HP-6 decision 1                                       | no — final pass                     |
...
| Workstream 12 (operator docs)                                  | open                | B6-13 (branch only)                                           | no           | PR when merged                                                                 | no                                  |
...
| Workstream 17 (docs carryover)                                 | open                | B6-14 PR #1620 (open)                                         | no           | PR when merged                                                                 | no                                  |
| Workstream 18 (BPR-053/trust-model)                            | pending             | B6-15 (branch only)                                           | no           | B6-15's landing sentence, copied verbatim                                      | no — waits for B6-15                |
