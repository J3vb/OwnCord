...
| B6-14    | Service-boundary handle reconciliation                   | Every direct database-handle use, not only imports, has a named service, adapter or transaction-boundary owner, and the guard rejects unclassified access — with replay locking and persister ordering preserved                                                                                                                                                                                                                                                                                                                                                                                                                     | in-progress | [b6-14-service-boundary-handles.plan.md](../../.claude/plans/b6-14-service-boundary-handles.plan.md)                         | 17         |
