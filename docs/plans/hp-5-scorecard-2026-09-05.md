...
| #TBD-B5-4  | B5-4 — Web Push subscription storage, nothing dispatched                                 | pending    | pending         |
| #1544      | B5-5 — rich-content inventory, GIF result-URL hygiene, S-03 pinned                       | pending    | pending         |
...
| ----- | ------------------------------------- | --------------- | ---------- |
| B5-4  | `feature/b5-4-push-subscriptions`     | pending         | #TBD-B5-4  |
| B5-5  | `feature/b5-5-rich-content-inventory` | pending         | #1544      |
