...
| C-10                   | **B7 half open**; B8 half deferred                 | Item 1 above                                                                                                                                                                                                                               |
...
| OC-\*                  | none open                                          | All 29 B7-tagged OC rows are `fixed` in `.superpowers/findings-ledger.json`, so rule 2 is met. The ledger's one open finding, OC-0445, is a B6 capacity finding and is not tagged B7                                                       |
...
| B7-18     | —                                                    | confirmed 2026-09-23: all 29 B7-tagged OC-\* rows are `fixed` (rule 2 met); C-10's B7 half is still open ([B7-18 reconciliation](#b7-18-reconciliation-2026-09-23))          |
