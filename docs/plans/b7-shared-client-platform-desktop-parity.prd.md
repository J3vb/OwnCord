...
> B7 half is closed and the voice-join budget is now recorded and enforced, and
> the `tauri-build` item is accepted as a deviation (D-07, 2026-09-25 — the
> release PR runs it); see
...
| -------- | ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| B7-0     | Verify claims and record the entry baselines           | Every roadmap claim entering the phase is re-checked against HEAD and the missing baselines (startup, memory, client coverage %, mutation score, knip hints, import cycles, bundle sizes) are recorded once, so later milestones ratchet against real numbers instead of guesses                                                                                                                                                                                                                                                                                                                                                                                      | complete          | [b7-0-verify-and-baseline.plan.md](../../.claude/plans/b7-0-verify-and-baseline.plan.md) — [#1626](https://github.com/J3vb/OwnCord/pull/1626), startup/memory [#1642](https://github.com/J3vb/OwnCord/pull/1642)                                                                                                                    | 13, 15 (baseline half), entry gate |
| B7-1     | Honest client gates locally and in CI                  | A contributor cannot merge past a lint, knip, coverage, or import-cycle regression that today only shows up if someone runs the full suite by hand                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | complete          | [b7-1-honest-client-gates.plan.md](../../.claude/plans/b7-1-honest-client-gates.plan.md) — [#1631](https://github.com/J3vb/OwnCord/pull/1631)                                                                                                                                                                                       | 4                                  |
| B7-2     | Node/npm support policy settled                        | Contributors and CI build against one documented major Node/npm version instead of an open-ended `>=` range that can drift silently                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | complete          | [b7-2-node-npm-support-policy.plan.md](../../.claude/plans/b7-2-node-npm-support-policy.plan.md) — [#1628](https://github.com/J3vb/OwnCord/pull/1628)                                                                                                                                                                               | 17                                 |
| B7-3     | Platform contracts and the desktop adapter shell       | Every native-dependent responsibility has a typed contract and a `platform/desktop` home to move into, before any code actually moves                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | complete          | [b7-3-platform-contracts-desktop-shell.plan.md](../../.claude/plans/b7-3-platform-contracts-desktop-shell.plan.md) — [#1630](https://github.com/J3vb/OwnCord/pull/1630)                                                                                                                                                             | 1, entry gate item 2               |
| B7-4     | Adapter migration, connectivity and identity           | HTTP, WebSocket, credentials, identity, pending messages, profiles/settings, and logs/filesystem all reach native APIs through the desktop adapter, with app behavior unchanged from a user's perspective                                                                                                                                                                                                                                                                                                                                                                                                                                                             | complete          | [b7-4-adapter-connectivity-identity.plan.md](../../.claude/plans/b7-4-adapter-connectivity-identity.plan.md) — [#1635](https://github.com/J3vb/OwnCord/pull/1635)                                                                                                                                                                   | 2                                  |
| B7-5     | Adapter migration, media and shell                     | Media/devices, LiveKit's native proxy, push-to-talk, notifications, window state, deep links, updater, and app metadata all reach native APIs through the desktop adapter, closing off any remaining direct `@tauri-apps` import outside it                                                                                                                                                                                                                                                                                                                                                                                                                           | complete          | [b7-5-adapter-media-shell.plan.md](../../.claude/plans/b7-5-adapter-media-shell.plan.md) — [#1646](https://github.com/J3vb/OwnCord/pull/1646)                                                                                                                                                                                       | 2                                  |
| B7-6     | Target-neutral Vite split and the desktop compile gate | The build config stops assuming one platform: a shared config plus a desktop overlay makes `build:desktop` an explicit, checked target                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | complete          | [b7-6-vite-split-desktop-gate.plan.md](../../.claude/plans/b7-6-vite-split-desktop-gate.plan.md) — [#1633](https://github.com/J3vb/OwnCord/pull/1633)                                                                                                                                                                               | 3                                  |
| B7-7     | Bundle and runtime budgets                             | Startup, route, LiveKit, RNNoise, and feature-chunk sizes are enforced in CI instead of drifting unnoticed. **Amended 2026-09-20 (owner decision, factual correction):** the outcome's second clause ("LiveKit/RNNoise no longer load on the startup path") was already satisfied before this milestone started — `main.ts` imported `@lib/livekitSession` dynamically at the PRD's own base commit `ccd9a5d`, and B7-0's record calls `livekitSession` "the largest lazy chunk". What B7-7 actually delivers is the enforcement (CI bundle budgets) and the RNNoise deep-import fix, which removes 1.9 MB of dead embedded WASM from the lazy `livekitSession` chunk | complete          | [b7-7-bundle-runtime-budgets.plan.md](../../.claude/plans/b7-7-bundle-runtime-budgets.plan.md) — [#1645](https://github.com/J3vb/OwnCord/pull/1645)                                                                                                                                                                                 | 5                                  |
| B7-8     | Mutation baseline refreshed before decomposition       | The mutation score is recorded once, honestly, as the number every later decomposition milestone is measured against                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | complete          | [b7-8-mutation-baseline.plan.md](../../.claude/plans/b7-8-mutation-baseline.plan.md) — [#1644](https://github.com/J3vb/OwnCord/pull/1644)                                                                                                                                                                                           | 15                                 |
| B7-9     | Decompose voice                                        | The two largest voice modules split into ownership-scoped files with colocated tests, with supersession and staleness behavior proven unchanged, not just assumed unchanged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | complete          | [b7-9-decompose-voice.plan.md](../../.claude/plans/b7-9-decompose-voice.plan.md) — [#1657](https://github.com/J3vb/OwnCord/pull/1657), [#1662](https://github.com/J3vb/OwnCord/pull/1662)                                                                                                                                           | 6, 16                              |
...
| B7-12    | Compatible update and incompatible state               | A connected user gets a clear update notice when the server says a newer compatible release exists, and lands in a safe, exitable state when the server's epoch is incompatible                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | complete          | [b7-12-compatible-update-incompatible-state.plan.md](../../.claude/plans/b7-12-compatible-update-incompatible-state.plan.md) — [#1655](https://github.com/J3vb/OwnCord/pull/1655)                                                                                                                                                   | 8, 14                              |
| B7-13    | One connection, isolated profiles, quick switch        | A user has exactly one live connection and one live media session at a time; switching profiles tears the old one down completely and isolates the new one's credentials and cache                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | complete          | [b7-13-one-connection-isolated-profiles.plan.md](../../.claude/plans/b7-13-one-connection-isolated-profiles.plan.md) — [#1654](https://github.com/J3vb/OwnCord/pull/1654)                                                                                                                                                           | 9                                  |
| B7-14    | Multi-device session management                        | A user sees every device signed into their account, is told about a new sign-in, and can revoke one device or all of them                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | complete          | [b7-14-multi-device-sessions.plan.md](../../.claude/plans/b7-14-multi-device-sessions.plan.md) — [#1661](https://github.com/J3vb/OwnCord/pull/1661)                                                                                                                                                                                 | 10                                 |
| B7-15    | Account lifecycle desktop flows                        | Sign-up honestly reflects the server's registration mode including a pending-approval state, recovery works end to end from the client, deletion discloses retention, and a user can export their own local support bundle without a server call; `server-info` gains `registration_mode` and a retention summary (decisions 2, 3)                                                                                                                                                                                                                                                                                                                                    | complete          | [b7-15-account-lifecycle-desktop-flows.plan.md](../../.claude/plans/b7-15-account-lifecycle-desktop-flows.plan.md) — [#1658](https://github.com/J3vb/OwnCord/pull/1658), [#1660](https://github.com/J3vb/OwnCord/pull/1660), [#1669](https://github.com/J3vb/OwnCord/pull/1669), [#1671](https://github.com/J3vb/OwnCord/pull/1671) | 11                                 |
| B7-16    | Desktop external-content broker                        | External content (link previews, embeds, media) is fetched through a bounded, budgeted, cache-partitioned broker instead of unbounded native fetches, closing the desktop half B5 deferred                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | complete          | [b7-16-external-content-broker.plan.md](../../.claude/plans/b7-16-external-content-broker.plan.md) — [#1648](https://github.com/J3vb/OwnCord/pull/1648)                                                                                                                                                                             | B5 carry-over                      |
...
| B7-18    | Register, traceability and roadmap reconciliation      | The issue register and roadmap match what B7 actually shipped, with every deferral to B8 recorded against the exact artifacts left behind                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | in-progress       | Reconciled 2026-09-23 — [B7-18 reconciliation](#b7-18-reconciliation-2026-09-23); the phase exit stays open on the items listed there                                                                                                                                                                                               | exit                               |
...
### B7-18 reconciliation (2026-09-23)
...
1. **C-10, B7 half: the desktop CSP is not minimized.** The "What each
   milestone closes" table assigned C-10's B7 half to B7-6. B7-6
   ([#1633](https://github.com/J3vb/OwnCord/pull/1633)) split the Vite config
   and did not change the CSP. B7-16
   ([#1648](https://github.com/J3vb/OwnCord/pull/1648)) removed `https:` from
   `img-src`. `connect-src` in `Client/src-tauri/tauri.conf.json` still allows
   `https:` and `wss:` to any host, because the LiveKit SDK fetches the
   operator's LiveKit host from the renderer (`docs/security.md` "Known
...
2. **Closed 2026-09-23: the client voice-join budget is recorded and
   ...
   **Exit-gate evidence: there is no client voice-join budget.** The exit gate
   ...
   [#1645](https://github.com/J3vb/OwnCord/pull/1645)), the startup and
   memory baseline ([#1642](https://github.com/J3vb/OwnCord/pull/1642)) and
   the long-session soak (B7-11). No milestone recorded a baseline or budget
   for client voice-join. The server's voice-join budget is B6's
   (`docs/capacity.md`). The owner can accept the gap or have the budget
   measured.
3. **Decision on `tauri-build` for PRs into `dev` was not implemented.** The
   decision (2026-09-19) was to run `tauri-build` on PRs into `dev` when the
   Rust crate or the packaging configuration changes. B7-6
   ([#1633](https://github.com/J3vb/OwnCord/pull/1633), "Known limitation")
   left `.github/workflows/ci.yml`'s `tauri-build` job gated on
   `base_ref == 'main'` because of its cost and struck the acceptance row that
   depended on it. B7-6 put a `build:desktop` compile in Client Static Checks
   on every client PR in its place. The owner can confirm that deviation or
   ask for the job.

**Limits carried from B7-17 and HP-7.** These do not block the exit, because
the owner signed HP-7 with them:

- **Nightly schedule inert until the main carry.** GitHub registers a
  scheduled workflow only from the default branch. The `schedule` trigger in
  `.github/workflows/client-artifact-smoke.yml` (B7-17) does not fire until
  the file reaches `main`. The same applies to `nightly-test-depth.yml`'s
  full-client Stryker run (B7-8,
  [#1644](https://github.com/J3vb/OwnCord/pull/1644)) and its long soak
  (B7-11).
- **First-release Windows ARM64 update N/A.** No earlier release carries a
  Windows ARM64 build to update from. `Client/tests/e2e/artifact-smoke/update.spec.ts`
  therefore skips that target's update leg, with the reason, until the next
  release.
...
| ---------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| C-02, C-03, C-04, C-05 | closed                                             | B7-1 [#1631](https://github.com/J3vb/OwnCord/pull/1631). The statement floor was 90 % at B7-1 and rose to 93 % by [#1677](https://github.com/J3vb/OwnCord/pull/1677) and [#1728](https://github.com/J3vb/OwnCord/pull/1728)                                                   |
| C-07, C-08             | B7 half closed; B9 tag kept                        | B7-7 [#1645](https://github.com/J3vb/OwnCord/pull/1645)                                                                                                                                                                                                                       |
| C-09, SEC-03, BG-19    | desktop half closed                                | B7-16 [#1648](https://github.com/J3vb/OwnCord/pull/1648). BG-19's journeys stay with B9                                                                                                                                                                                       |
| C-10                   | **B7 half closed 2026-09-23**; B8 half deferred    | Item 1 above; `connect-src` is loopback only                                                                                                                                                                                                                                  |
| C-11                   | closed                                             | B7-10 [#1677](https://github.com/J3vb/OwnCord/pull/1677)                                                                                                                                                                                                                      |
| C-12                   | B7 half closed; B9 tag kept                        | voice [#1657](https://github.com/J3vb/OwnCord/pull/1657), [#1662](https://github.com/J3vb/OwnCord/pull/1662); dispatcher and stores [#1670](https://github.com/J3vb/OwnCord/pull/1670), [#1672](https://github.com/J3vb/OwnCord/pull/1672)                                    |
| C-13                   | lifecycle clause closed; other two clauses to B9   | B7-11 [#1702](https://github.com/J3vb/OwnCord/pull/1702), [#1703](https://github.com/J3vb/OwnCord/pull/1703), [#1728](https://github.com/J3vb/OwnCord/pull/1728)                                                                                                              |
| C-16                   | B7 half closed; B10 tag kept                       | B7-8 [#1644](https://github.com/J3vb/OwnCord/pull/1644)                                                                                                                                                                                                                       |
| L-02                   | desktop half closed; browser half deferred to B8   | B7-3 [#1630](https://github.com/J3vb/OwnCord/pull/1630), B7-4 [#1635](https://github.com/J3vb/OwnCord/pull/1635), B7-5 [#1646](https://github.com/J3vb/OwnCord/pull/1646)                                                                                                     |
| L-03                   | `build:desktop` closed; `build:web` deferred to B8 | B7-6 [#1633](https://github.com/J3vb/OwnCord/pull/1633)                                                                                                                                                                                                                       |
| BG-04                  | B7 half closed; B8 half deferred                   | B7-17 [#1737](https://github.com/J3vb/OwnCord/pull/1737) (note already in the row)                                                                                                                                                                                            |
| BG-07                  | B7 re-verification done                            | B7-12 [#1655](https://github.com/J3vb/OwnCord/pull/1655) (note already in the row)                                                                                                                                                                                            |
| OC-\*                  | none open                                          | All 29 B7-tagged OC rows are `fixed` in `.superpowers/findings-ledger.json`, so rule 2 is met. The ledger's open findings at HP-9 (2026-09-25) are all low and none is tagged B7 (the register carries the live counts; OC-0454, OC-0473, OC-0474, OC-0476, OC-0478, OC-0479) |

**Traceability.** Each BPR row has its B7 evidence in
[the traceability doc](beta-requirements-traceability-2026-08-23.md), written
by the milestone that delivered it:

- BPR-033: B7-12.
- BPR-034: B7-13.
- BPR-035: B7-14.
- BPR-044 and BPR-046: B7-15b.
- BPR-054 and BPR-055: B7-15c.
- BPR-010: B7-17.

B7-18 added nothing to that doc.

**Deferred to B8, and the artifacts left for it.** The roadmap's B8 "What
already exists" list names the same artifacts:

- **Contracts, adapter and contract suites (L-02 browser half, roadmap ws 2).**
  - 21 type-only contracts in `Client/src/platform/contracts/`.
  - The desktop implementations in `Client/src/platform/desktop/`.
  - 23 behaviour suites in `Client/tests/unit/platform/*.suite.ts`. The
    `*.desktop.test.ts` files run them against the desktop adapter.

  B8 adds `Client/src/platform/browser/`, which does not exist yet, and runs
  the same suites against it.

- **Native-import isolation.**
  - The "Native imports stay behind the desktop seam" block in
    `Client/eslint.config.js`. It exempts only `src/platform/desktop/**`.
  - `Client/tests/unit/platform-contracts-counts.test.ts`.
  - `docs/architecture/platform-contracts.md`.
- **Build split (L-03 `build:web`, roadmap ws 3).**
  - The shared `Client/vite.config.ts` and the `Client/vite.config.desktop.ts`
    overlay.
  - The `build:desktop` script. Plain `build` is an alias for it, so B8's web
    target can take the plain name.
- **CSP and origins (C-10 B8 half).** The browser-mode origin allowlist.
- **Browser parity (BG-04 B8 half, BPR-020 to BPR-025).**
  - The desktop reference that browser parity is measured against: the
    artifact smoke in `.github/workflows/client-artifact-smoke.yml`.
  - `GET /api/v1/server-info`, which B7-15
    ([#1658](https://github.com/J3vb/OwnCord/pull/1658)) extended with
    `registration_mode` and `retention`.
...
| B7-18     | —                                                    | confirmed 2026-09-23: all 29 B7-tagged OC-\* rows are `fixed` (rule 2 met); C-10's B7 half closed 2026-09-23 ([B7-18 reconciliation](#b7-18-reconciliation-2026-09-23))      |
...
_Status: B7-0 to B7-17 complete and HP-7 signed. B7-18 reconciled on 2026-09-23. The phase exit is open on one item, the `tauri-build`-on-`dev` decision (D-07 accepted as a deviation 2026-09-25; the release PR runs it); C-10's B7 half closed and the voice-join budget was recorded 2026-09-23; see [B7-18 reconciliation](#b7-18-reconciliation-2026-09-23)._
