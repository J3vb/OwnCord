...
| B7-7     | Bundle and runtime budgets                             | Startup, route, LiveKit, RNNoise, and feature-chunk sizes are enforced in CI instead of drifting unnoticed, and LiveKit/RNNoise no longer load on the startup path                                                                                                                                                                 | pending  | [b7-7-bundle-runtime-budgets.plan.md](../../.claude/plans/b7-7-bundle-runtime-budgets.plan.md)                     | 5                                  |
