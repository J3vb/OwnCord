...
Generated from the migrated schema by `cd Server && go run ./cmd/gendocs` — do not edit by hand; `make docs-verify` fails when it drifts. 34 tables, SQLite's own bookkeeping and the FTS5 shadow tables included.
