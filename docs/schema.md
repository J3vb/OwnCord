...
| `erasure_jobs`             | `id INTEGER PK`, `user_id INTEGER NOT NULL`, `state TEXT NOT NULL`, `files TEXT NOT NULL`, `files_removed INTEGER NOT NULL`, `attempts INTEGER NOT NULL`, `last_error TEXT`, `created_at TEXT NOT NULL`, `updated_at TEXT NOT NULL`, `finished_at TEXT`                                                                                                                                              | `idx_erasure_jobs_state`                                                                                                |
