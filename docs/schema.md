...
| `message_requests`         | `id INTEGER PK`, `sender_id INTEGER NOT NULL`, `recipient_id INTEGER NOT NULL`, `channel_id INTEGER NOT NULL`, `state TEXT NOT NULL`, `created_at TEXT NOT NULL`, `decided_at TEXT`                                                                                                                                                                                                                  | `idx_message_requests_recipient_state`, `sqlite_autoindex_message_requests_1`                                           |
