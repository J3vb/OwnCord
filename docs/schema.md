...
| `052_retention_revision.sql`                   | Adds a durable retention-policy revision and triggers covering server settings, channel overrides and cascade removal. Proposed previews compare this revision atomically when applied (RI-08).                                                                                                                                                                                                                                        |
...
| `reports`                   | `id INTEGER PK`, `public_id TEXT NOT NULL`, `reporter_id INTEGER NOT NULL`, `reporter_token TEXT`, `subject_id INTEGER NOT NULL`, `subject_token TEXT`, `target_type TEXT NOT NULL`, `target_ref TEXT NOT NULL`, `channel_id INTEGER`, `reason TEXT NOT NULL`, `detail TEXT NOT NULL`, `state TEXT NOT NULL`, `assignee_id INTEGER NOT NULL`, `outcome TEXT NOT NULL`, `created_at TEXT NOT NULL`, `updated_at TEXT NOT NULL`, `closed_at TEXT` | `idx_reports_active_unique`, `idx_reports_dedupe`, `idx_reports_queue`, `idx_reports_reporter`, `idx_reports_subject`, `sqlite_autoindex_reports_1` |
