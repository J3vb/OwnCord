...
| `retention_runs`           | `id INTEGER PK`, `started_at TEXT NOT NULL`, `finished_at TEXT`, `channels INTEGER NOT NULL`, `messages_deleted INTEGER NOT NULL`, `files TEXT NOT NULL`, `files_removed INTEGER NOT NULL`, `last_error TEXT`                                                                                                                                                                                        | —                                                                                                                       |
